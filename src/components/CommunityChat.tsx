          ...
          {filteredEvents.map((evt) => {
            ...
            return (
              ...
              >
                ...
                {/* Bottom Row: Attendees Info (Left) & RSVP Button (Right) */}
                <div className="flex items-center justify-between pt-0.5">
                  <div className="flex items-center gap-1.5 text-[11px] font-medium text-[#8E8E93]">
                    <Users className="w-3.5 h-3.5" />
                    <span>{evt.attendees + (isRsvped ? 1 : 0)} attending</span>
                  </div>
      ...
      {selectedEvent && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3.5 bg-black/70 backdrop-blur-xs animate-in fade-in duration-200">
          ...
          >
            ...
            {/* Modal Actions */}
            <div className="flex items-center justify-between gap-2.5 pt-3.5 border-t border-[#EBEBEF] dark:border-[#27272A]">
              <a
